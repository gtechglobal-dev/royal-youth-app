...
export const addSpecialDonation = async (req, res) => {
  try {
    ...
    try { await sendPushNotification(targetId, purpose, `Your donation of ₦${amount} has been recorded. Thank you! Your profile has been updated accordingly.`, "/dashboard", notif._id.toString()); } catch (e) {}
