...
function PostCard({ post, currentUserId, onDelete, onShare }) {
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 mb-4">
      ...
      <div className="flex items-start gap-2 sm:gap-3 px-3 sm:px-4 pt-3 sm:pt-4">
      ...
      {/* Content - edge to edge with small padding */}
      <div className="px-2 sm:px-4 mt-3">
        {editing ? (
          ...
          <>
            <p className="text-sm text-gray-800 whitespace-pre-wrap">{postText || (post.images?.length ? "Say something about your image(s)" : "")}</p>
          ...
          <>
            <p className="text-sm text-gray-800 whitespace-pre-wrap">{postText || "Say something about your image(s)"}</p>
            <img
              src={post.imageUrl}
              alt="Post"
          ...
          <div
            className="rounded-xl px-6 py-10 text-center flex items-center justify-center relative overflow-hidden w-full min-h-[130px]"
            style={{
      ...
      {/* Action buttons */}
      <div className="flex items-center gap-4 px-3 sm:px-4 pt-3 pb-3 sm:pb-4 border-t border-gray-100 mt-3">
