...
function BannerGallery() {
  ...
  if (isLoading) {
    return (
      <div className="w-full h-[25vh] sm:h-[30vh] md:h-[40vh] lg:h-[50vh] bg-gradient-to-br from-indigo-100 via-purple-50 to-indigo-100 flex items-center justify-center">
  ...
  if (banners.length === 0) {
    return (
      <div className="w-full h-[25vh] sm:h-[30vh] md:h-[40vh] lg:h-[50vh] bg-gradient-to-br from-indigo-100 via-purple-50 to-indigo-100 flex flex-col items-center justify-center gap-4">
  ...
  return (
    <div
      className="relative w-full h-[25vh] sm:h-[30vh] md:h-[40vh] lg:h-[50vh] overflow-hidden bg-gray-900"
