      ...
      <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl overflow-hidden">
        ...
        <div className="p-5 space-y-4">
          <div className="flex gap-3">
            <button
              onClick={() => { stopPreview(); setType("video"); }}
              className={`flex-1 py-3 rounded-xl font-semibold text-sm border-2 transition ${type === "video" ? "border-purple-600 bg-purple-50 text-purple-700" : "border-gray-200 text-gray-500 hover:border-gray-300"}`}
            >
            ...
            <button
              onClick={() => { stopPreview(); setType("audio"); }}
              className={`flex-1 py-3 rounded-xl font-semibold text-sm border-2 transition ${type === "audio" ? "border-purple-600 bg-purple-50 text-purple-700" : "border-gray-200 text-gray-500 hover:border-gray-300"}`}
            >
              <svg className="w-5 h-5 mx-auto mb-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
