                    ...
                    return (
                      <div key={n._id} className={`text-sm ${n.read ? "" : "bg-purple-50"}`}>
                        <div className="p-3 border-b border-gray-50">
                          <div className="flex items-start gap-2 cursor-pointer hover:bg-gray-50" onClick={() => { if (n.type === "reminder") { setExpandedNotif(isExpanded ? null : n._id); } else { navigate(n.type === "message" ? "/messages" : n.type === "friend_request" || n.type === "friend_accept" ? "/dashboard" : n.type === "live-started" ? `/live/${n.referenceId}` : n.type === "live-ended" ? "/dashboard" : `/dashboard?post=${n.referenceId}`); } }}>
                            <div className="flex-1 min-w-0">
                              {n.type === "reminder" ? (
                                ...
                                <p className={`${n.read ? "text-gray-600" : "text-gray-900 font-semibold"}`}><span className="font-semibold">{displayName(n.fromUserId)}</span> {n.type === "like" ? "liked your post" : n.type === "comment" ? "commented on your post" : n.type === "friend_accept" ? "accepted your friend request" : n.type === "friend_request" ? "sent you a friend request" : n.type === "live-started" ? "is live now" : n.type === "live-ended" ? "ended their live" : "sent you a message"}</p>
                              )}
                            </div>
